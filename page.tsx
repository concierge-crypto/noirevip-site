...
export default function NoireWebsite() {
  ...
  const content = useMemo(() => {
    return activeTab === "home" ? <Home /> : <LaxLanding />;
  }, [activeTab]);
    ...
    <div className="sticky top-0 z-50 border-b border-zinc-900/70 bg-zinc-950/70 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        ...
        <div className="hidden items-center gap-2 md:flex">
          ...
          <NavPill
            label="LAX"
            active={activeTab === "lax"}
            onClick={() => setActiveTab("lax")}
          />
          <a
            href="tel:13104224708"
            className="ml-2 rounded-2xl bg-zinc-50 px-4 py-2 text-sm font-semibold text-zinc-950 hover:bg-zinc-200"
          >
        ...
        <div className="md:hidden">
          <button
            onClick={() => setActiveTab(activeTab === "home" ? "lax" : "home")}
    ...
    <button
      ...
      className={
        ...
        (active
          ...
          : "text-zinc-300 hover:text-zinc-50 hover:bg-zinc-900/60 border border-transparent")
      }
    >
      {label}
    </button>
          ...
          <div>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-3">
              <a
                ...
                className="rounded-2xl bg-zinc-50 px-5 py-3 text-sm font-semibold text-zinc-950 hover:bg-zinc-200"
              >
                {ctaPrimary.label}
              </a>
              {ctaSecondary && (
                <a
                  ...
                  className="rounded-2xl border border-zinc-800 bg-zinc-950 px-5 py-3 text-sm font-semibold text-zinc-50 hover:bg-zinc-900"
                >
                  {ctaSecondary.label}
                </a>
              )}
              <div className="w-full text-xs text-zinc-400 md:w-auto">
                All requests are personally reviewed.
              </div>
            </div>
          ...
          <div className="rounded-3xl border border-zinc-900 bg-gradient-to-b from-zinc-950 to-zinc-900/40 p-6 shadow-2xl">
            ...
            <div className="mt-6 space-y-3">
              <FleetRow
                ...
                note="Celebrity & high-profile clients"
              />
              <FleetRow
                name="Chevrolet Suburban"
                note="Executive & airport elite"
              />
  ...
  return (
    <div className="rounded-3xl border border-zinc-900 bg-zinc-950/40 p-6 shadow-sm">
      <div className="flex items-center gap-3">
        <div className="rounded-2xl border border-zinc-800 bg-zinc-950 p-2 text-zinc-50">
          {icon}
        </div>
  ...
  return (
    <div>
      <Hero
        ...
        subtitle={
          <>
            A private chauffeur service for executives, celebrities, and private
            clients.
            <br />
      ...
      <Section kicker="WHY" title="NOIRE Standards">
        <div className="grid gap-4 md:grid-cols-3">
          <Card
            ...
            desc="Unbranded vehicles and NDA-ready service for high-profile clients."
          />
          <Card
            icon={<Shield className="h-5 w-5" />}
            title="One Client • One Chauffeur"
            desc="Dedicated, consistent experience — calm, professional, and private."
          />
          <Card
            icon={<Sparkles className="h-5 w-5" />}
            title="White-Glove Service"
            desc="Terminal coordination, luggage assistance, and uncompromising standards."
          />
        </div>
      </Section>
      ...
      <Section kicker="FLEET" title="Escalade • Suburban • EQS">
        <div className="grid gap-4 md:grid-cols-3">
          <FleetCard
            name="Cadillac Escalade"
            tag="Celebrity"
            desc="For high-profile clients and premium events."
          />
          <FleetCard
            name="Chevrolet Suburban"
            tag="Executive"
            desc="Corporate transport and airport elite."
          />
          <FleetCard
            name="Mercedes EQS"
            tag="Silent"
            desc="Executive electric luxury with a quiet presence."
          />
        </div>
      </Section>
      ...
      <Section id="airport" kicker="AIRPORT" title="LAX Private Chauffeur">
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-3xl border border-zinc-900 bg-zinc-950/40 p-6">
            ...
            <a
              href="#request"
              className="mt-6 inline-flex rounded-2xl bg-zinc-50 px-5 py-3 text-sm font-semibold text-zinc-950 hover:bg-zinc-200"
            >
          ...
          <div className="rounded-3xl border border-zinc-900 bg-zinc-950/40 p-6">
            ...
            <div className="mt-4 text-xs text-zinc-400">
              Ultra-luxury service. Fixed pricing. No negotiations.
            </div>
          </div>
        </div>
      </Section>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-3xl border border-zinc-900 bg-zinc-950/40 p-6">
            <div className="text-sm font-semibold">
              Designed for executives & private clients
            </div>
            <div className="mt-2 text-sm text-zinc-300">
              Dedicated chauffeur, fixed availability, priority scheduling, and
              consistent service.
            </div>
            <ul className="mt-4 space-y-3 text-sm text-zinc-300">
            ...
            <a
              href="#request"
              className="mt-6 inline-flex rounded-2xl border border-zinc-800 bg-zinc-950 px-5 py-3 text-sm font-semibold text-zinc-50 hover:bg-zinc-900"
            >
      ...
      <Section kicker="LAX" title="The NOIRE Airport Standard">
        <div className="grid gap-4 md:grid-cols-3">
          <Card
            ...
            desc="Flight tracking, discreet terminal coordination, and smooth curbside pickup."
          />
          <Card
            icon={<Lock className="h-5 w-5" />}
            title="Discreet by Default"
            desc="Unbranded vehicles. Signage only if requested. NDA-ready."
          />
          <Card
            icon={<Sparkles className="h-5 w-5" />}
            title="White-Glove Assistance"
            desc="Professional chauffeurs, luggage assistance, and a calm, private arrival."
          />
        </div>
      </Section>
      ...
      <Section id="fleet" kicker="FLEET" title="Choose Your Vehicle">
        <div className="grid gap-4 md:grid-cols-3">
          <FleetCard
            name="Cadillac Escalade"
            tag="Celebrity"
            desc="Premium SUV for high-profile arrivals."
          />
          <FleetCard
            name="Chevrolet Suburban"
            tag="Executive"
            desc="Corporate, family, and airport elite."
          />
          <FleetCard
            name="Mercedes EQS"
            tag="Silent"
            desc="Executive electric luxury."
          />
        </div>
      </Section>
...
function FleetCard({
  ...
  return (
    <div className="rounded-3xl border border-zinc-900 bg-zinc-950/40 p-6">
      ...
      <a
        href="#request"
        className="mt-6 inline-flex rounded-2xl border border-zinc-800 bg-zinc-950 px-4 py-2 text-sm font-semibold hover:bg-zinc-900"
      >
      ...
      <div className="grid gap-10 md:grid-cols-2 md:items-start">
        <div>
          ...
          <h2 className="mt-2 text-2xl font-semibold md:text-3xl">
            Request {isLax ? "Private LAX Chauffeur" : "Private Chauffeur"}
          </h2>
          <p className="mt-3 text-sm text-zinc-300">
            Discreet service for executives, celebrities, and private clients.
            All requests are personally reviewed and confirmed.
          </p>
          ...
          <div className="mt-8 rounded-3xl border border-zinc-900 bg-zinc-950/40 p-6 text-sm text-zinc-300">
            <div className="font-semibold text-zinc-50">
              NDA-ready • Unbranded • White-glove
            </div>
        ...
        <form
          onSubmit={(e) => {
            e.preventDefault();
            alert(
              "Thank you. Your private request has been received. Our concierge will contact you shortly."
            );
          }}
        ...
        >
          <div className="grid gap-4">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Select
                label="Service"
                options={["Airport (LAX)", "Hourly (Min 3 hrs)", "Monthly", "Event"]}
                defaultValue={isLax ? "Airport (LAX)" : "Airport (LAX)"}
              />
              <Select
                label="Vehicle"
                options={["Escalade", "Suburban", "Mercedes EQS", "No Preference"]}
            ...
            <TextArea
              label="Notes"
              placeholder="Pickup details, number of passengers, luggage, special requests…"
            />

            <button
              type="submit"
              className="mt-2 rounded-2xl bg-zinc-50 px-5 py-3 text-sm font-semibold text-zinc-950 hover:bg-zinc-200"
            >
              Submit Private Request
            </button>

            <div className="text-xs text-zinc-400">
              Your request will be personally confirmed.
            </div>
          </div>
        </form>
      </div>
...
function Field({ label, placeholder }: { label: string; placeholder: string }) {
  return (
    <label className="grid gap-2">
      ...
      <input
        className="h-11 rounded-2xl border border-zinc-800 bg-zinc-950 px-4 text-sm text-zinc-50 placeholder:text-zinc-600 focus:outline-none focus:ring-2 focus:ring-zinc-600"
  ...
  return (
    <label className="grid gap-2">
      ...
      <select
        ...
        className="h-11 rounded-2xl border border-zinc-800 bg-zinc-950 px-4 text-sm text-zinc-50 focus:outline-none focus:ring-2 focus:ring-zinc-600"
      >
        {options.map((o) => (
    ...
    <footer className="border-t border-zinc-900/70">
      <div className="mx-auto flex max-w-6xl flex-col gap-3 px-4 py-10 md:flex-row md:items-center md:justify-between">
        ...
        <div className="text-xs text-zinc-500">
          © {new Date().getFullYear()} NOIRE Private Chauffeur. All rights reserved.
        </div>
      </div>
    </footer>
  );
